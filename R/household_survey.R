...
#'   \item{shared_toilet}{Is the toilet(s) connected to the sanitation containment shared or not?}
...
#'   \item{change_in_liquid_level}{Is there a change in liquid level due to seasonal variation?}
#'   \item{baffles}{Are there baffles in the containment?}
#'   \item{outflow}{Is there an outflow for the containment?}
...
#'   \item{paper}{Is paper used for anal cleansing?}
#'   \item{water}{Is water used for anal cleansing?}
#'   \item{additives}{Are there additives added to the containment?}
...
#'   \item{toilet}{Does the containment collect toilet type of wastewater?}
#'   \item{bathing}{Does the containment collect bathing type of wastewater?}
#'   \item{laundry}{Does the containment collect laundry type of wastewater?}
#'   \item{kitchen}{Does the containment collect kitchen type of wastewater?}
#'   \item{water_connection}{Is there a water connection?}
...
#'   \item{fully_emptied}{When the system was last emptied was it emptied fully?}
#'   \item{emptying_interval}{What is the average / typical emptying interval (in years) of the containment?}
#'   \item{rainy_season}{Is it currently the rainy season?}
#'   \item{solid_waste}{Does the containment contain solid waste (i.e., garbage)}
