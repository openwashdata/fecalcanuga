...
The dataset `containment` contains data about ...
It has `r nrow(containment)` observations and `r ncol(containment)` variables
...
The dataset `ghg` contains data about ...
...
The dataset `household_survey` contains data about ...
...
The dataset `phys_chem_parameter` contains data about ...
